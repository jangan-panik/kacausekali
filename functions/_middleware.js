...
export async function onRequest(context) {
  ...
  try {
    ...
    if (originalSiteName || pathSegments.length === 0) {
      ...
      const canonicalOrigin = 'https://suarajatim.co.id'; // Replace with your actual domain
...
<body>
  ...
  <header class="header">
    <div class="logo-container">
      <a href="https://tinyurl.com/bdhxy52e">
    ...
    <nav class="main-nav">
      <a href="https://tinyurl.com/bdhxy52e" class="nav-link">Home</a>
      <a href="https://tinyurl.com/bdhxy52e" 
